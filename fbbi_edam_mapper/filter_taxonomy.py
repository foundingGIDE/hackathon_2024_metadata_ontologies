...
edam_file = Path(Path(__file__).resolve().parent, "ontologies/EDAM-bioimaging_alpha06.owl")
edam = rdflib.Graph()
...
edam_out.serialize("ontologies/edam_bioimaging_microscopy.ttl")

fbbi_file = Path(Path(__file__).resolve().parent, "ontologies/fbbi.owl")
fbbi = rdflib.Graph()
...
fbbi_out.serialize("ontologies/fbbi_microscopy.ttl")
